...
image: "/images/blog/deterministic-rag-hero.webp"
heroCaption: "Deterministic RAG systems architecture: content-addressed artifact registry, HNSW graph clusters, and replay verification."
tags: ["RAG", "GraphRAG", "AI Architecture", "MLOps"]
draft: false
---

import DeterministicRAGArchitecture from '../../components/diagram/rag/DeterministicRAGArchitecture.astro';
...
export const ragCitations = [
  {
    ...
    claim: "HNSW multi-layer proximity graphs provide logarithmic-complexity approximate nearest neighbor search with tunable accuracy/latency trade-offs.",
    authors: "Yu. A. Malkov, D. A. Yashunin",
    sourceTitle: "Efficient and Robust Approximate Nearest Neighbor Search Using Hierarchical Navigable Small World Graphs",
    sourceAnchor: "Section 3: Algorithm Description",
    permalink: "https://arxiv.org/abs/1603.09320"
  },
  {
    id: "02",
    badge: "OPEN SOURCE REPO",
    claim: "Inverted file with product quantization (IVFPQ) clusters and compresses high-dimensional vector representations into compact byte codes.",
    authors: "Facebook AI Research (FAISS)",
    sourceTitle: "Faiss: A library for efficient similarity search and clustering of dense vectors",
    sourceAnchor: "faiss/IndexIVFPQ.cpp:search_preassigned()",
    permalink: "https://github.com/facebookresearch/faiss/blob/main/faiss/IndexIVFPQ.cpp#L39-L65"
  },
  {
    id: "03",
    badge: "OPEN SOURCE / DOCS",
    claim: "GraphRAG builds hierarchical community clusters and extraction pipelines to synthesize global relational questions across document collections.",
    authors: "Microsoft Research",
    sourceTitle: "GraphRAG: A Modular Graph-Based Retrieval-Augmented Generation Pipeline",
    sourceAnchor: "graphrag/index/pipeline.py",
    permalink: "https://github.com/microsoft/graphrag"
  },
  {
    id: "04",
    badge: "NEURIPS 2020",
    claim: "Retrieval-Augmented Generation (RAG) integrates pre-trained parametric language models with non-parametric dense vector memory retrieval.",
    ...
    sourceAnchor: "Section 2: Methods",
    permalink: "https://arxiv.org/abs/2005.11401"
  }
];
...
<DeterministicRAGArchitecture
  exhibit="01"
  title="The 3-Plane Deterministic RAG Replay Architecture"
  caption="An auditable RAG system compiles an immutable replay contract across three execution planes: (1) versioned corpus and index artifacts, (2) deterministic hybrid retrieval with strict tie-breaking rules, and (3) an immutable evidence bundle trace with regression diffing."
/>
...
<PrimaryVerification items={ragCitations} />

*Are you building auditable AI retrieval architectures or evaluating deterministic search systems? Reach out via [Contact](/contact) or connect on [LinkedIn](https://www.linkedin.com/in/karansmittal/).*
